...
public class Program {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var orderDate = new Date(System.currentTimeMillis());
        var con = DriverManager.getConnection("jdbc:oracle:thin:@//iitdac.met.edu/xepdb1", "dac", "metiit");
        con.setAutoCommit(false); //enable explicit transaction handling
        try{
